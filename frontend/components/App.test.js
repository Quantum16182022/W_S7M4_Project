...
//     */
//       let texts = getEntriesByKeyPrefix(text.en, 'TEXT')
...
//     let texts = getEntriesByKeyPrefix(text.esp, 'TEXT')
//       for ( let [key, val] of texts) {
//         test(`${key} is visible`, () => {
//           render(<App />)
//           expect(screen.getByText(val)).toBeVisible()
...
//     let labels = getEntriesByKeyPrefix(text.esp, 'LABEL')
//       for ( let [key, val] of labels) {
//         test(`${key} is visible`, () => {
//           render(<App />)
//           expect(screen.getByLabelText(val)).toBeVisible()
...
//   expect(getEntriesByKeyPrefix(obj, "Bruh")).toEqual([])
//     })
//   }) 
// })
